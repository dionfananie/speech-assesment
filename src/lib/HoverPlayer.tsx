...
export default function HoverPlayer() {
  const result = useHoveredParagraphCoordinate(getTopLevelReadableElementsOnPage())
  
  return result ? <PlayButton style={{top: result.top,
    left: result.left}} onClick={() => speechify(result.element)} /> : null
}
